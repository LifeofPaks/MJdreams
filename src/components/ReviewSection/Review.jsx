  ...
  return (
    <section class="review">
      <div class="top">
        ...
        <div className="rounded top-btns">Conference events & conventions</div>
      </div>
      <div class="review-container ">
        ...
        <div class="review-cards">
          ...
          <div className="card">
            ...
            <p className="text t1">
              ...
              outstanding, and the customer service was exceptional.Totally worth it!"
            </p>
            <div className="profile">
          ...
          <div className="card">
            ...
            <p className="text t1">
              ...
              professional, and friendly. I’ll definitely be returning
        ...
        <button className="primary-btn imp-btn">
